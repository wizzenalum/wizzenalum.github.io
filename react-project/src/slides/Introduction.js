  ...
  render() {
    ...
    return (
      <div id="intro">
        ...
        <p id="typewriter">
          Who graduated in mechanical engineering from NIT, Uttarakhand with
          minor degree in Compputer Science. during the engineering i realise my
          passion towards computers science. and here i am, daily learning
          DataStructure, Algorithm, DBMS, system design, python, javascript,
          nodejs....
        </p>
      </div>
    );
